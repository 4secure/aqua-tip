      ...
      <div className="w-full max-w-lg relative z-10">
        <div className="bg-surface border border-border rounded-xl p-8">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="font-sans text-2xl font-bold text-text-primary">Privacy Policy</h1>
          </div>

          {/* Placeholder content */}
          <div className="text-text-secondary font-mono text-sm leading-relaxed space-y-4">
            <p>
              Our Privacy Policy will be available soon. Please check back later.
            </p>
            <p className="text-text-muted text-xs">
              AQUA TIP is committed to protecting your privacy and handling your data responsibly.
            </p>
          </div>
