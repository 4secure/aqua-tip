  ...
  return (
    <div className="space-y-3">
      <button
        ...
        className="w-full flex items-center justify-center gap-3 px-4 py-2.5 bg-surface-2 border border-border rounded-lg text-sm text-text-primary hover:border-violet/30 hover:bg-surface-3 transition-all duration-200 cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
      >
        <GoogleIcon />
