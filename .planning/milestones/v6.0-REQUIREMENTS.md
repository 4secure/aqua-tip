# Requirements Archive: v6.0 Feature Gating & UX Polish
...
- [x] **OBS-01**: Email observable type renders with formatted display in threat search results
- [x] **OBS-02**: URL observable type renders with clickable link in threat search results
- [x] **OBS-03**: Cryptocurrency observable type renders with formatted display in threat search results

### UI Polish

- [x] **UI-01**: Settings page profile form is horizontally centered on the page
- [x] **UI-02**: Landing page globe renders immediately on first mount (no scroll trigger delay)
- [x] **UI-03**: Landing page animations are smooth with no jank or delayed renders

### D3 Relationship Graph

- [x] **D3-01**: User can zoom in on relationship graph via button control
- [x] **D3-02**: User can zoom out on relationship graph via button control
...
| OBS-01 | Phase 56 | Complete |
| OBS-02 | Phase 56 | Complete |
| OBS-03 | Phase 56 | Complete |
| UI-01 | Phase 57 | Complete |
| UI-02 | Phase 57 | Complete |
| UI-03 | Phase 57 | Complete |
| D3-01 | Phase 58 | Complete |
| D3-02 | Phase 58 | Complete |
